                    ...
                    <div className="mt-8">
                        ...
                        <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                            ...
                            <tr className="divide-x-1 divide-gray-200">
                                <th className="py-2 px-4 border-b-2 border-gray-200 text-left text-gray-600">Product Name (Englis)
                                </th>
                                <th className="py-2 px-4 border-b-2 border-gray-200 text-left text-gray-600">Product Name (Russian)</th>
